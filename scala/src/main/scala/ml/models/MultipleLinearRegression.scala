...
object MultipleLinearRegression {
  def main(args: Array[String]): Unit = {
    ...
    println("Constant: " + lrModel.intercept)
    println("Coefficient: " + lrModel.coefficients)
    ...
    //Firstly all were selected however radio's p values were too big so it needs to be reduced from model.
    /*
     ...
     */
    // TV 50 radyo 10
    val predictDF = Seq((50.0, 10.0),(75.2,55.8)).toDF("TV","Radio")
    predictDF.show()
